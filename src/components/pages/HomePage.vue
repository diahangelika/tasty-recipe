  ...
  <div class="container-md my-5 py-5">
    <div class="recipe__title text-center">
      ...
      <p style="font-size: 15px;">
        ...
        Discover recipes, cooks, videos, and how-tos based on the food you 
        love and the friends you follow.
      </p>
    </div>
...
<!--  KODE INI UDAH GA DIPAKE LAGI SOALNYA SEKARANG KAN DATA RESEPNYA DISIMPEN DI FIREBASE
